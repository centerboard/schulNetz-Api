# schulNetz OpenAPI Specification
[![Build Status](https://travis-ci.org/centerboard/schulNetz-Api.svg?branch=master)](https://travis-ci.org/centerboard/schulNetz-Api)
...
6. If you did everything correct, https://centerboard.github.io/schulNetz-Api/ will lead to your new docs
...
- Documentation(ReDoc): https://centerboard.github.io/schulNetz-Api/
- SwaggerUI: https://centerboard.github.io/schulNetz-Api/swagger-ui/
- Look full spec:
    + JSON https://centerboard.github.io/schulNetz-Api/swagger.json
    + YAML https://centerboard.github.io/schulNetz-Api/swagger.yaml
- Preview spec version for branch `[branch]`: https://centerboard.github.io/schulNetz-Api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://centerboard.github.io/schulNetz-Api/ with url from the message: `Server started <url>`
